...
// Define props types for Menubar components
...
const MenubarTrigger = React.forwardRef<HTMLButtonElement, MenubarTriggerProps>(({ className, ...props }, ref) => (
...
const MenubarSubTrigger = React.forwardRef<HTMLButtonElement, MenubarSubTriggerProps>(({ className, inset, children, ...props }, ref) => (
...
const MenubarSubContent = React.forwardRef<HTMLDivElement, MenubarSubContentProps>(({ className, ...props }, ref) => (
...
const MenubarItem = React.forwardRef<HTMLDivElement, MenubarItemProps>(({ className, inset, ...props }, ref) => (
...
const MenubarCheckboxItem = React.forwardRef<HTMLDivElement, MenubarCheckboxItemProps>(({ className, children, checked, ...props }, ref) => (
...
const MenubarRadioItem = React.forwardRef<HTMLDivElement, MenubarRadioItemProps>(({ className, children, ...props }, ref) => (
...
const MenubarLabel = React.forwardRef<HTMLDivElement, MenubarLabelProps>(({ className, inset, ...props }, ref) => (
...
const MenubarShortcut = ({ className, ...props }: MenubarShortcutProps) => {
  return (
    <span
      className={cn("ml-auto text-xs tracking-widest textHere's the complete code for your Menubar component using Radix UI, which allows for a customizable menu structure in a React application:
